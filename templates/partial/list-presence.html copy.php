        ...
        <div class="form-list-presence">
            ...
            <div>
                <select name="referentiel" id="" class="select-presence">
                    ...
                    <option value="dev_web" <?php if(isset($_POST['referentiel']) && $_POST['referentiel'] == 'dev_web') echo "selected"?>>Dev Web/Mobile</option>
                    <option value="dev_data" <?php if(isset($_POST['referentiel']) && $_POST['referentiel'] == 'dev_data') echo "selected"?>>Dev Data</option>
                    <option value="ref_dig" <?php if(isset($_POST['referentiel']) && $_POST['referentiel'] == 'ref_dig') echo "selected"?>>Referent Digital</option>
                    <option value="aws" <?php if(isset($_POST['referentiel']) && $_POST['referentiel'] == 'aws') echo "selected"?>>AWS</option>
                    <option value="securite" <?php if(isset($_POST['referentiel']) && $_POST['referentiel'] == 'securite') echo 'selected'?>>Sécurité</option>
                </select>
            </div>
            <div>
                <input type="date" placeholder="MM/DD/YYYY" class="form-control-presence">
            </div>
            <div>
